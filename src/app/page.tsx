...
export const metadata: Metadata = {
  ...
  description: 'Calculate inflation-adjusted dollars between any years using official CPI data. See how purchasing power changes over time. Free, instant, no signup needed. Free CPI-based inflation calculator with detailed analysis and historical data from 1960-2026.',
  keywords: [
