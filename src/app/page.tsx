    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
          ...
          <div className="space-y-6">
            {faqData.map((item, idx) => (
              ...
              >
                ...
                <p className="mt-4 text-[#8B95A1] leading-relaxed">
                  {item.answer}
                </p>
              </details>
            ))}
        ...
        <section className="max-w-4xl mx-auto px-4 py-12 space-y-8">
          <article className="card">
            ...
            <p className="text-[#8B95A1] leading-relaxed mb-4">
          ...
          <article className="card">
            ...
            <ol className="space-y-3 text-[#8B95A1]">
          ...
          <article className="card">
            ...
            <div className="space-y-4 text-[#8B95A1]">
              <div>
        ...
        {/* Footer */}
        <footer className="border-t border-[#E5E8EB] mt-16 py-8 text-center text-sm text-[#8B95A1]">
          <p className="mb-2">
      ...
      <section id="content-depth-section" className="mt-20 max-w-3xl mx-auto px-6 relative z-[1]">
        <h2 className="text-h2 mb-6 text-[#191F28]">Complete Guide</h2>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">What Is Inflation and Why Does It Matter?</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">How the Consumer Price Index (CPI) Works</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">Types of Inflation and Their Causes</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">Historical US Inflation: Key Periods</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[#191F28]">Using Inflation Data for Financial Planning</h3>
